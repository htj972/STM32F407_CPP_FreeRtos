...
CRC32_MPEG2::CRC32_MPEG2() {
    ...
    CRC_ResetDR();
    CRC32_MPEG2::init_flag=1;
}

CRC32_MPEG2::~CRC32_MPEG2() {
    CRC_ResetDR();
    RCC_AHB1PeriphClockCmd(RCC_AHB1Periph_CRC, DISABLE);
    CRC32_MPEG2::init_flag=0;
}

void CRC32_MPEG2::clear() {
    CRC_ResetDR();
}

uint32_t CRC32_MPEG2::CalcCRC(uint32_t Data) {
    return CRC_CalcCRC(Data);
}

uint32_t CRC32_MPEG2::CalcBlockCRC(uint32_t *pBuffer, uint32_t BufferLength) {
...
uint16_t CRC16_Modbus::Compute(uint8_t *puchMsg, uint16_t usDataLen)
{
